...
export default function FormStep1({ formData, updateFormData, nextStep }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Prepare simplified application data as per new API schema
      ...
      // Save application data to localStorage for next step
      ...
      <div style={formStyles.card}>
        ...
        {error && (
          <div style={formStyles.error}>
            {error}
            {(error.includes("Please login") || error.includes("Session expired") || error.includes("No token found") || error.includes("User data not found")) && (
        ...
        <form onSubmit={handleSubmit}>
          <div style={formStyles.row}>
            <div style={formStyles.col}>
              <div style={formStyles.formGroup}>
                <label style={formStyles.label} htmlFor="name">Full Name</label>
                <input
                  type="text"
            ...
            <div style={formStyles.col}>
              <div style={formStyles.formGroup}>
                <label style={formStyles.label} htmlFor="loanType">Loan Type</label>
                <select
          ...
          <div style={formStyles.row}>
            <div style={formStyles.col}>
              <div style={formStyles.formGroup}>
                <label style={formStyles.label} htmlFor="amount">Loan Amount</label>
