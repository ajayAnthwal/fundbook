...
export default function FormStep2({ formData, updateFormData, nextStep, prevStep }) {
  ...
  useEffect(() => {
    ...
    // Get application ID from previous step if available
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Prepare business details data with all required fields
      const businessData = {
        email: localFormData.email,
        mobile: String(localFormData.mobile), // Ensure mobile is string
        businessType: {
      ...
      if (!response.ok) {
        throw new Error(responseData.message || 'Failed to submit business details');
      }
      ...
      <div style={formStyles.card}>
          ...
          <div style={formStyles.error}>
            ...
            {(error.includes("Please login") || error.includes("Session expired")) && (
              <div style={{ marginTop: '1rem' }}>
                <a href="/auth" style={{ ...formStyles.button, display: 'inline-block', width: 'auto', padding: '0.5rem 1rem' }}>
                  Go to Login
                </a>
              </div>
            )}
        ...
        <form onSubmit={handleSubmit}>
          <div style={formStyles.row}>
            <div style={formStyles.col}>
              <div style={formStyles.formGroup}>
                <label style={formStyles.label} htmlFor="email">Business Email</label>
                <input
                  type="email"
            ...
            <div style={formStyles.col}>
              <div style={formStyles.formGroup}>
                <label style={formStyles.label} htmlFor="mobile">Business Contact Number</label>
                <input
                  type="tel"
                  style={formStyles.input}
                  id="mobile"
          ...
          <div style={formStyles.row}>
            <div style={formStyles.col}>
              <div style={formStyles.formGroup}>
                <label style={formStyles.label} htmlFor="businessType">Business Type</label>
                <select
            ...
            <div style={formStyles.col}>
              <div style={formStyles.formGroup}>
                <label style={formStyles.label} htmlFor="gst">GST Number</label>
                <input
                  type="text"
                  style={formStyles.input}
                  id="gst"
          ...
          <div style={formStyles.formGroup}>
            <label style={formStyles.label} htmlFor="udyam">Udyam Registration Number</label>
            <input
              type="text"
              style={formStyles.input}
              id="udyam"
